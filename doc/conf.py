...
distribution = pkg_resources.require('bob.db.verification.filelist')[0]
...
htmlhelp_basename = 'bob_db_verification_filelist_doc'
...
latex_documents = [
  ('index', 'bob_db_verification_filelist.tex', u'Bob',
